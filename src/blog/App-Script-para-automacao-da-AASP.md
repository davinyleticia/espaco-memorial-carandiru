---
layout: "post.njk"
title: AppScript para automação da AASP
tags: ['chatgpt', 'python', 'api']
featuredImage: /_images/02.jpg
permalink: post/projetos-developer/App-Script-para-automacao-da-AASP/
date: 2021-10-27
description: Script Google Apps Script para Importar Dados da API de Intimação da AASP
---
...
Este script é distribuído sob os termos da Licença Pública Geral GNU (GNU GPL), conforme detalhado a seguir. Além disso, incluí o crédito para a autora, Dáviny Letícia Vidal, como solicitado.
...
Este script foi desenvolvido por Dáviny Letícia Vidal. Daviny é a autora original do código fornecido neste script. Ao utilizar este script, por favor, mantenha o crédito para Dáviny Letícia Vidal.
